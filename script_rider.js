...
function one() {
    ...
    document.getElementById('myimage').src = "./image/How-to-Step-1-สมัครลงทะเบียน.png";
...
function two() {
    ...
    document.getElementsByClassName("button4")[0].style.backgroundImage = "none";
    document.getElementsByClassName("button4")[0].style.color = "rgb(168,9,124)";
    document.getElementById('myimage').src = "./image/How-to-Step-2-อัพโหลดเอกสาร.png";
...
function three() {
    ...
    document.getElementsByClassName("button4")[0].style.backgroundImage = "none";
    document.getElementsByClassName("button4")[0].style.color = "rgb(168,9,124)";
    document.getElementById('myimage').src = "./image/How-to-Step-3-อบรม.png";
...
function four() {
    ...
    document.getElementsByClassName("button2")[0].style.backgroundImage = "none";
    document.getElementsByClassName("button2")[0].style.color = "rgb(168,9,124)";
    document.getElementById('myimage').src = "./image/How-to-Step-4-เปิดระบบ-รับงานทันที.png";
...
$(document).ready(function () {
    $("#flip").click(function () {
        ...
        if ($('#down13 img').attr('src') == "./image/Group-4-2.png") {
            $('#down13 img').attr('src', "./image/Group-4-1.png");
        }
    });
});
$(document).ready(function () {
...
$(document).ready(function () {
    $("#flip13").click(function () {
        // Change src attribute of image
        if ($('#down13 img').attr('src') == "./image/Group-4-1.png") {
            $('#down13 img').attr('src', "./image/Group-4-2.png");
        } else if ($('#down13 img').attr('src') == "./image/Group-4-2.png") {
            $('#down13 img').attr('src', "./image/Group-4-1.png");
        }
        else if ($('#down13 img').attr('src') == "./image/Group-4-1.png") {
            $('#down13 img').attr('src', "./image/Group-4-2.png");
        }
        if ($('#down1 img').attr('src') == "./image/Group-4-2.png") {
            $('#down1 img').attr('src', "./image/Group-4-1.png");
